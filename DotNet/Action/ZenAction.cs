...
*        in another tutorial
*     2) Element implementation that is executed in orchestration engine process. This document is code template for creating element implementations
*   
...
namespace ZenAction
{
    ...
    */
    public class ZenAtion : IZenAction, IZenNodePreInit, IZenNodeInit
    {
        ...
        /**
        * First in series of element callbacks. Executed when orchestration engine is finished with elements loading.
        ...
        *
        * @param    element  : contains all necessary information about current element (property values, last executed time, last error....)
        * @param    elements : all elements. Useful for getting results, errors, states... from other elements or executing them dynamically.
        *
        * @return	void
        */
        ...
        #region OnNodeInit
        /**
        * Second in series of element callbacks. Executed on first element run.
        ...
        */
        ...
        #region ID
        /** 
        * Element id that user defines in Visual Development Tool 
        */
        ...
        *   - actions (debug prints in Visual Development Tool debug console...)
        */
        ...
        /** 
        * Last in series of element callbacks, repeatable executed when element connected in loop. Here goes main element logic.
        *
        * @param    elements: all elements. Useful for getting results, errors, states... from other elements or executing them dynamically.
        * @param    element : contains all necessary information about current element (property values, last executed time, last error....)
        * @param    iAmStartedYou : contains id of the element, that started current one. This can be elemented that precede current element,
        *           or any other element, not directly connected to current one, but is dynamically execute it.
        */
        public void ExecuteAction(Hashtable elements, IPlugin element, IPlugin iAmStartedYou)
        {
            ...
            // Element has outputs, true (green connection) and false (red connection), which can be connected to other elements inputs.
            // Zenodys Computing Engine proceeds on green connection if IsConditionMet property is true and on red connection otherwise.
            // Some elements have just true connections. If you don't set IsConditionMet property, workflow will hang because initial value is false.
